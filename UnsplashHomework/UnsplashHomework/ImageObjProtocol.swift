...
class ImageObjProtocol: URLProtocol {
    ...
    final override func startLoading() {
        ...
        ImageObjProtocol.queue.asyncAfter(deadline: DispatchTime(uptimeNanoseconds: 500 * NSEC_PER_MSEC), execute: block)
    }
    
    final override func stopLoading() {
        ImageObjProtocol.queue.async {
    ...
    static func urlSession() -> URLSession {
        ...
        config.protocolClasses = [ImageObjProtocol.classForCoder()]
